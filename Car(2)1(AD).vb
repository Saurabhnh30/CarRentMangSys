...
Public Class Car_2_1_AD_
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        TextBox11.Text = FormatNumber(diff.TotalDays, 0)

        Dim num1, num2, vat, product As Single
        num1 = TextBox11.Text
        num2 = TextBox12.Text
        product = num1 * num2
        TextBox14.Text = product

        vat = 0.35 * TextBox14.Text
        TextBox13.Text = vat
        TextBox14.Text = vat + TextBox14.Text
    End Sub
    ...
    Private Sub Car_2_1_AD__Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        cmd.ExecuteNonQuery()
        con.Close()
        MsgBox(" Your Chevrolet Sail 1.3 LT ABS has been Booked ")
