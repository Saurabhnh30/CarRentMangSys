...
Public Class Car_2_2_AD_
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        cmd.ExecuteNonQuery()
        con.Close()
        MsgBox(" Your Ford Figo Aspire 1.5 TDCi Titanium  has been Booked ")
    End Sub
    ...
    Private Sub Car_2_2_AD__Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        My.Computer.Audio.Play(My.Resources.click, AudioPlayMode.Background)
        TextBox11.Text = Val(ComboBox3.Text) - Val(ComboBox2.Text)
