...
Public Class Car3_AD_
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        cmd.ExecuteNonQuery()
        con.Close()
        MsgBox(" Your CHyundai Grand i10 CRDi Asta has been Booked ")
    End Sub

    Private Sub Car3_AD__Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        My.Computer.Audio.Play(My.Resources.click, AudioPlayMode.Background)
